...
from base.exceptions import TooManyRequestsException, BaseAPIException
from users.choices import FriendRequestStatusChoices
...
class FriendsHandler:
    ...
    def get_all_pending_friend_requests(self, user, page_num, search_term):
        ...
        response_data['pending_requests'] = [
            UserHandler().generate_profile_response(
                pending_friend_request.to_user, jwt=False) for pending_friend_request in
            paginated_response.object_list]
        response_data['total_pages'] = paginator.num_pages
        response_data['current_page'] = int(page_num)
        return response_data
    ...
    def send_friend_request(self, user, to_profile_id):
        ...
        return UserHandler().generate_profile_response(friend_request.to_user)

    def take_action_on_friend_request(self):
        pass
